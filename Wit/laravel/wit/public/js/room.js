...
window.bootstrap = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js"); //ページ離脱防止禁止
...
var host_id = document.getElementById('Host-User').dataset.hostId;
var me_id = document.getElementById('Me').dataset.authId;
var message = document.getElementById('Message');
var send_button = document.getElementById('Send-Message-Button');
var upload_file_button = document.getElementById('Upload-File-Button');
var input_file = document.getElementById('Upload-File-Input');
var confirm_upload_modal = new bootstrap.Modal(document.getElementById('Confirm-Upload-Modal')); //ファイルアップロード確認メッセージの入力

input_file.addEventListener('change', function () {
  var file = input_file.files[0];
  var confirm_upload_message = document.getElementById('Confirm-Upload-Message');
  var file_name = document.createElement('p');
  var file_size = document.createElement('p');
  var file_help1 = document.createElement('p');
  var file_help2 = document.createElement('p');
...
document.getElementById('Confirm-Upload-Modal').addEventListener('hidden.bs.modal', function () {
...
upload_file_button.addEventListener('click', function (e) {
  var file = input_file.files[0];
...
function fileSizeUnit(size) {
  ...
  var round = function round(size, unit) {
...
function removeOnlineUser(user) {
  var user_mark = $('li[data-user-id="' + user.id + '"]');
...
function scrollDownChat() {
  $('#Room-Chat .card-body').animate({
    scrollTop: $('#Room-Chat .card-body')[0].scrollHeight,
    duration: 'fast'
  });
}
...
function addChatMessage(e) {
  ...
  if (e.user.id === me_id) {
    ...
    var _span_element = document.createElement('span');

    _span_element.classList = "badge text-dark";
    _span_element.textContent = getNowDate(type);

    var _p_element = document.createElement('p');

    _p_element.innerText = e.message;

    _div.appendChild(user_image);

    _div.appendChild(user_name);

    _div.appendChild(_span_element);

    _div2.appendChild(_p_element);

    message_element.appendChild(_div);
    message_element.appendChild(_div2);
    message_list.appendChild(message_element);
  }
}
...
function addUploadFile(e) {
  ...
  if (e.user.id === me_id) {
    ...
    var _span_element2 = document.createElement('span');

    _span_element2.classList = "badge text-dark";
    _span_element2.textContent = getNowDate(type);

    var _a_element = document.createElement('a');

    _a_element.onclick = window.onbeforeunload = null;
    _a_element.href = '/home/room:' + e.room_id + '/downloadRoomFile:' + e.post_file;
    _a_element.innerHTML = "<svg width='16' height='16' fill='currentColor' class='bi bi-file-earmark mx-2' viewBox='0 0 16 16'><path d='M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z'/></svg>" + e.post_file;

    _div3.appendChild(user_image);

    _div3.appendChild(user_name);

    _div3.appendChild(_span_element2);

    _div4.appendChild(_a_element);

    message_element.appendChild(_div3);
    message_element.appendChild(_div4);
    message_list.appendChild(message_element);
  }
}
...
if (document.getElementById('Confirm-Ban-Modal')) {
  var confirm_ban_modal = document.getElementById("Confirm-Ban-Modal");
  confirm_ban_modal.addEventListener('shown.bs.modal', function (event) {
    var modal_body = $(confirm_ban_modal).find('.modal-body');
    modal_body.children().remove();
    var button = event.relatedTarget;
    var ban_uesr_id = document.getElementById('Ban-User');
    var ban_room_id = document.getElementById('Ban-Room');
...
if (document.getElementById('Lift-Ban-User-Modal')) {
  var lift_ban_user_modal = document.getElementById("Lift-Ban-User-Modal");
  lift_ban_user_modal.addEventListener('shown.bs.modal', function (event) {
    var modal_body = $(lift_ban_user_modal).find('.modal-body');
    modal_body.children().remove();
    var button = event.relatedTarget;
    var lift_user_id = document.getElementById('Lift-Ban-User');
    var lift_room_id = document.getElementById('Lift-Ban-Room');
