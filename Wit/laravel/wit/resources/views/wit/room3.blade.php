                ...
                <div class="container-fluid">
                    <div class="col-2 d-none d-md-block ">
                        <div id="hostUser" class="d-flex justify-content-center">
                            <img src="{{ asset('/images/wit/wit.png') }}" alt="" width="50px" height="50px"
                                class="rounded-circle m-1">
                            <strong class="d-flex align-items-center">haruki</strong>
                        </div>
                    </div>

                    <div class="col-10 col-md-8 text-wrap fw-bold">
                        <h4 class="d-none d-md-block">画像ナシ用ルームのテスト</h4>
                        <p class="d-sm-none">画像ナシ用ルームのテスト</p>
                    </div>
