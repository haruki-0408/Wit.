        ...
        <div class="card-body p-1">
            <div class="card-title col-12 p-2 text-center">
                <p class="fw-bold">
                    ...
                    ご不明点、ご意見ございましたら下記フォームまでお問い合わせください。
                </p>
            </div>
            ...
            <div class="p-3 row justify-content-center">
                <div class="form-box-table text-start col-md-12; col-lg-6">
                    ...
                    <textarea id="Inquiry" class="w-100 bg-light" rows="5" name="inquiry_sentence" autocorrect="off" autocapitalize="off" placeholder=""></textarea>
            ...
            <div class="card-text row justify-content-center">
                <div class="col-2 text-end">
                    <svg width="50" height="50" fill="red"
                        class="bi bi-exclamation-triangle p-0 m-0" viewBox="0 0 16 16">
                        <path
