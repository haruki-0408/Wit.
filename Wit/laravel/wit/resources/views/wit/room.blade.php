...
<div style="width:90px;" class="offcanvas offcanvas-end" tabindex="-1" id="Offcanvas-Right"
    ...
    <div class="offcanvas-body d-flex flex-column align-items-center p-2">
        ...
        <div data-bs-toggle="modal" data-bs-target="#Access-Logs-Modal" class="Access-Log pb-3">
...
<!--
<div class="modal fade" id="Redirect-Remove-Room" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="Redirect-Remove-Room" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><svg width="16" height="16" fill="currentColor"
