<div class="Trend-tag fs-5">
    ...
    <ul>
        ...
        <li><a class="tag" href="#">PHP<span class="badge badge-dark">194</span></a></li>
        <li><a class="tag" href="#">Twitter</a></li>
        <li><a class="tag" href="#">Programming</a></li>
        <li><a class="tag" href="#">Movie</a></li>
        <li><a class="tag" href="#">Unique</a></li>
...
<div class="Favorite-tag fs-5">
    ...
    <ul>
        ...
        <li><a class="tag" href="#">Science</a></li>
