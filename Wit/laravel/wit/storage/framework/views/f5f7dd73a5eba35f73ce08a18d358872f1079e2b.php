            ...
            <div class="modal-body">
                <ul id="My-OpenRoom-List" class="p-1 m-0 ">
                    <?php $__env->startComponent('wit.room-content'); ?>
                        <?php $__env->slot('rooms', $open_rooms); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul id="My-PostRoom-List" class="p-1 m-0">
                    <?php $__env->startComponent('wit.room-content'); ?>
                        <?php $__env->slot('rooms', $post_rooms); ?>
                    <?php echo $__env->renderComponent(); ?>
                </ul>
                <?php if(!isset($post_rooms->last()->no_get_more) && $post_rooms->isNotEmpty()): ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-1">
                <ul id="My-ListUser-List" class="fs-6 p-2">
                    <?php $__currentLoopData = $list_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list_user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li data-user-id="<?php echo e($list_user->id); ?>" class="d-flex bg-white p-1 justify-content-between">
                            <div class="User">
                                <a class="User-Link link-dark text-decoration-none d-flex align-items-center p-1"
                                    href="/home/profile:<?php echo e($list_user->id); ?>" alt="">
                                    <img src="<?php echo e(asset($list_user->profile_image)); ?>" alt="" width="50"
                                        height="50" class="Profile-Image rounded-circle me-2">
                                    <strong class="User-Name text-break"><?php echo e($list_user->name); ?></strong>
                                </a>
                            </div>
                ...
                <?php if(!isset($list_users->last()->no_get_more) && $list_users->isNotEmpty()): ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul id="My-ListRoom-List" class="p-1 m-0 ">
                    <?php $__env->startComponent('wit.room-content'); ?>
                        <?php $__env->slot('rooms', $list_rooms); ?>;
                    <?php echo $__env->renderComponent(); ?>
                </ul>
                <?php if(!isset($list_rooms->last()->no_get_more) && $list_rooms->isNotEmpty()): ?>
            ...
            <div class="modal-body">
                <div class="d-flex flex-column p-3">
                    ...
                    <form id="Room-Password-Form" name='room_password' method="post"
                        ...
                        <?php $__errorArgs = ['enter_password'];
...
<div class="modal fade" id="Tags-Modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex flex-column p-3  ">
                    <?php $__env->startComponent('wit.tags'); ?>
                    <?php echo $__env->renderComponent(); ?>
                </div>
            </div>
            <div class="modal-footer">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="User-Password-Form1" name='user_password' method="post"
                    ...
                    <?php $__errorArgs = ['information_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="User-Password-Form2" name='user-password' method="post"
                    ...
                    <?php $__errorArgs = ['change_email_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /var/www/laravel/wit/resources/views/wit/home-modals.blade.php ENDPATH**/ ?>