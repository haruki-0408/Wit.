                        ...
                        <div class="row h-100">
                            ...
                            <div class="d-none d-md-block d-lg-none">
                                ...
                                <ul id="Room-Informations-List3" class="col-12 p-1">
                                    <li class="text-break pb-2">Id : <?php echo e($room_info->id); ?></li>
                                    <li class="text-break">Created Time :
                                        <?php echo e($room_info->created_at->format('Y/m/d H:i')); ?>
...
<?php /**PATH /var/www/laravel/wit/resources/views/wit/post_room.blade.php ENDPATH**/ ?>