            ...
            <form id="Create-Room-Form" action="/home/createRoom" enctype="multipart/form-data" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input id="Input-Title" type="text" name="title" value="<?php echo e(old('title')); ?>"class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="Input-Description" class="form-control" type="text" name="description" rows="3"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php $__errorArgs = ['sum_image_size'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        <?php $__errorArgs = ['sum_image_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="Input-Tags" class="form-control" type="text" name="tag" value="<?php echo e(old('tag')); ?>" multiple>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php $__errorArgs = ['create_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /var/www/laravel/wit/resources/views/wit/create-room.blade.php ENDPATH**/ ?>