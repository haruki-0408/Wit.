        ...
        <main>
            <div class="Top mx-auto">
                <div class="row justify-content-center">
                    <div class="col-8">
                        <img width=100px height=100px src="<?php echo e(asset('/images/wit/wit.png')); ?> "">
            ...
            <div class="Auth-Button row justify-content-center mb-2">
                <div class="col-sm-12 text-center col-md-3"> <a href="<?php echo e(route('login')); ?>"
                        class="btn btn-primary px-4 m-2  ">ログイン</a> </div>
                <div class="col-sm-12 text-center col-md-3"> <a href="<?php echo e(route('register')); ?>"
...
<?php /**PATH /var/www/laravel/wit/resources/views/wit/index.blade.php ENDPATH**/ ?>