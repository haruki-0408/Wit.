            ...
            <form id="Change-Profile-Form" class="m-0 p-0" action="/home/profile/settings/changeProfile" method="post" name='change_profile'
                ...
                <div class="card-body p-1">
                    <div id="Parent-Image" class="text-center">
                        <img id="Child-Image" src="<?php echo e(asset(Auth::user()->profile_image)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="Parent-Name" class="row justify-content-center align-items-center">
                        ...
                        <p id="Child-Name" class="card-text col-10 col-md-4 text-center p-1 m-0"><?php echo e(Auth::user()->name); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="Parent-Email" class="row justify-content-center align-items-center">
                        ...
                        <p id="Child-Email" class="card-text col-10 col-md-4  text-center p-1 m-0"><?php echo e(Auth::user()->email); ?></p>
                    </div>
                    ...
                    <div id="Parent-Message" class="row justify-content-center align-items-center">
                        ...
                        <p id="Child-Message" class="card-text col-10 text-center col-md-4 p-1 m-0"
                            ...
                            <?php echo e(Auth::user()->profile_message); ?></p>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <h6 class="card-text col-10 col-md-4 text-center p-0"><?php echo e(Auth::user()->created_at); ?></h6>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/wit/resources/views/wit/Account/information-account.blade.php ENDPATH**/ ?>