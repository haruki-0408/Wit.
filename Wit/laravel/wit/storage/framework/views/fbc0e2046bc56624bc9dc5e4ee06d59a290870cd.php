<div id="Left-Sidebar" class="col-lg-3 col-md-4 d-flex flex-column p-3 bg-light d-none d-md-block">
    <div id="Profile-Box">
        <a href="/home/profile:<?php echo e(Crypt::encrypt(Auth::user()->id)); ?>"
        ...
        <div class="dropdown mb-3">
            <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle"
                ...
                <div id="profile" class="row">
                    <div class="col-3 inline"><img src="<?php echo e(asset(Auth::user()->profile_image)); ?>" alt=""
                    ...
                    <div class="col-9 d-flex align-items-center justify-content-center text-wrap text-break"><strong
                            class="p-1 m-1"><?php echo e(Auth::user()->name); ?></strong></div>
                </div>
            </a>
            ...
            <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
                ...
                <li><a class="dropdown-item" href="/home/profile:<?php echo e(Crypt::encrypt(Auth::user()->id)); ?>">Profile</a>
                </li>
                <li>
...
<?php /**PATH /var/www/laravel/wit/resources/views/wit/left.blade.php ENDPATH**/ ?>