...
<?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <li data-room-id="<?php echo e($room->id); ?>">
                ...
                <div class="btn-group d-flex align-items-center p-2">
                    <?php switch($room->type):
                        case (0): ?>
                            ...
                            <button type="button" data-bs-toggle="modal" data-bs-target="#Enter-Room-Modal"
                        ...
                        <?php case (1): ?>
                            ...
                            <button type="button" class="Enter-Room btn btn-outline-primary p-2" data-bs-toggle="modal"
                                data-bs-target="#Room-Password-Modal"><svg width="16" height="16" fill="currentColor"
                        ...
                        <?php case (11): ?>
                            ...
                            <button type="button" class="enter-room btn btn-outline-primary p-2" data-bs-toggle="modal"
                                data-bs-target="#Room-Password-Modal"><svg width="16" height="16"
                                    fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0v-2z" />
                                    <path fill-rule="evenodd"
                        ...
                        <?php case (100): ?>
                            <button type="button" data-bs-toggle="modal" data-bs-target="#Remove-Room-Modal"
        ...
        <div class="card-body p-1 row d-flex align-items-center m-0">
            <?php if(isset($room->password)): ?>
                <strong class="card-title m-0 pb-1 d-flex align-items-center"><?php echo e($room->title); ?>
            ...
            <?php else: ?>
                <strong class="card-title Room-Title m-0 pb-1 d-flex align-items-center text-break"><?php echo e($room->title); ?></strong>
            <?php endif; ?>
            <p class="card-text Room-Description text-break m-0"><?php echo nl2br(e($room->description)); ?></p>
            <?php if(is_null($room->posted_at)): ?>
                <small class="text-muted d-flex justify-content-end text-end">
                    <div class="mx-2 Count-Online-Users">
                        ...
                        </svg>x<?php echo e($room->count_online_users); ?>
                    ...
                    <div class="mx-2 Count-Chat-Messages">
                        ...
                        </svg>x<?php echo e($room->count_chat_messages); ?>
                    ...
                    <div class="Expired-Time-Left">
                        ...
                        </svg><?php echo e($room->expired_time_left); ?> Hours
                    </div>
                </small>
            <?php endif; ?>
            <small class="text-muted text-end">
                <div class="Create-Time">
                    <?php echo e($room->created_at); ?>
        ...
        <div class="card-footer border-0 bg-white p-0">
            <ul class="Room-Tags p-1">
                <?php $__currentLoopData = $room->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roomtag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="d-inline-block"><button class="tag" type="button"><span
                                class="tag-name"><?php echo e($roomtag->name); ?></span><span
                                class="tag-number badge badge-light"><?php echo e($roomtag->number); ?></span></button>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
    </li>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /var/www/laravel/wit/resources/views/wit/room-content.blade.php ENDPATH**/ ?>