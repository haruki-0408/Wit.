            ...
            <div class="modal-body">
                <ul id="Other-OpenRoom-List" class="p-1 m-0 ">
                    <?php $__env->startComponent('wit.room-content'); ?>
                        <?php $__env->slot('rooms', $o_open_rooms); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul id="Other-PostRoom-List" class="p-1 m-0">
                    <?php $__env->startComponent('wit.room-content'); ?>
                        <?php $__env->slot('rooms', $o_post_rooms); ?>
                    <?php echo $__env->renderComponent(); ?>
                </ul>
                <?php if(!isset($o_post_rooms->last()->no_get_more) && $o_post_rooms->isNotEmpty()): ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-1">
                <ul id="Other-ListUser-List" class="fs-6 p-2">
                    <?php $__currentLoopData = $o_list_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o_list_user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li data-user-id="<?php echo e($o_list_user->id); ?>" class="d-flex bg-white p-1 justify-content-between">
                            <div class="User">
                                <a class="User-Link link-dark text-decoration-none d-flex align-items-center p-1"
                                    href="/home/profile:<?php echo e($o_list_user->id); ?>" alt="">
                                    <img src="<?php echo e(asset($o_list_user->profile_image)); ?>" alt="" width="50"
                                        height="50" class="Profile-Image rounded-circle me-2">
                                    <strong class="User-Name text-break"><?php echo e($o_list_user->name); ?></strong>
                                </a>
                            </div>
                            <div class="btn-group d-flex align-items-center p-2">
                                <?php switch($o_list_user->type):
                                    case (0): ?>
                                    <?php break; ?>
                ...
                <?php if(!isset($o_list_users->last()->no_get_more) && $o_list_users->isNotEmpty()): ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul id="Other-ListRoom-List" class="p-1 m-0 ">
                    <?php $__env->startComponent('wit.room-content'); ?>
                        <?php $__env->slot('rooms', $o_list_rooms); ?>;
                    <?php echo $__env->renderComponent(); ?>
                </ul>
                <?php if(!isset($o_list_rooms->last()->no_get_more) && $o_list_rooms->isNotEmpty()): ?>
...
<?php /**PATH /var/www/laravel/wit/resources/views/wit/profile-modals.blade.php ENDPATH**/ ?>