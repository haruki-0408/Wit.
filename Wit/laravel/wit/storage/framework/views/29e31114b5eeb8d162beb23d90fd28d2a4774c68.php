...
<body>
    <div id="app">
        <header>
            <nav class="navbar navbar-expand-md navbar-light bg-light shadow-sm">
                <div class="container">
                    <a class="navbar-brand" href="<?php echo e(url('/home')); ?>">
                        <img style="width:40px;height:40px;" src="<?php echo e(asset('/images/wit/wit.png')); ?> ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="navbar-nav ms-auto">
                            ...
                            <?php echo $__env->yieldContent('home-only'); ?>


                            <?php if(auth()->guard()->guest()): ?>
                                <?php if(Route::has('login')): ?>
                                    <li class="nav-item">
                                        <a class="nav-link text-nowrap text-black" href="<?php echo e(route('login')); ?>">ログイン</a>
                                    </li>
                                <?php endif; ?>

                                <?php if(Route::has('register')): ?>
                                    <li class="nav-item">
                                        <a class="nav-link text-nowrap text-black" href="<?php echo e(route('register')); ?>">新規登録</a>
                                    </li>
                                <?php endif; ?>
                            <?php else: ?>
                                <li class="nav-item dropdown d-flex align-items-center justify-content-center">
                                    <a id="navbarUserName" class="link-dark text-decoration-none dropdown-toggle "
                                        ...
                                        v-pre>
                                        <strong style="font-size:10px;"><?php echo e(Auth::user()->name); ?></strong>
                                    </a>
            ...
            <div id="Action-Message" class="alert alert-success d-flex align-items-center fixed-top invisible"
                ...
                <div>
                    <?php echo e(session('action_message')); ?>
    ...
    <script>
        ...
        <?php elseif($errors->has('information_password')): ?>
        ...
        <?php elseif($errors->has('change_email_password')): ?>
        ...
        <?php elseif($errors->has('delete_password')): ?>
        ...
        <?php elseif($errors->has('enter_password')): ?>
            const room_id = '<?php echo e(old('room_id')); ?>';
...
<?php /**PATH /var/www/laravel/wit/resources/views/layouts/app.blade.php ENDPATH**/ ?>