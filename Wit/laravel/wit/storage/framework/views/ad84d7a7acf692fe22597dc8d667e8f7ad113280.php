<?php $__env->startSection('content'); ?>
    ...
    <?php if($user_id != Auth::id()): ?>
        <?php $__env->startComponent('wit.profile-modals',
            [
    ...
    <div id="Profile" class="overflow-auto" style="width:100%; height:85%;">
        <div class="container-sm p-3">
            <div class="header row">
                <div id="Target-User" data-user-id=<?php echo e(Crypt::encrypt($user_id)); ?> class="row align-items-center">
                    <div class="col-10 text-start">
                        <div class="profile row text-start d-flex align-items-center">
                            <div class="col-3 col-md-2 col-lg-1 p-1 justify-content-end d-flex">
                                <img src="<?php echo e(asset($profile_image)); ?>" alt="" width="50" height="50"
                                    class="rounded-circle d-inline">
                            </div>
                            <div class="col-9 col-md-10 col-lg-11 d-flex align-items-center p-0">
                                <strong class="text-break text-wrap"><?php echo e($user_name); ?></strong>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/wit/resources/views/wit/profile.blade.php ENDPATH**/ ?>